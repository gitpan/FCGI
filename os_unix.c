...
int OS_IsFcgi()
{
    ...
    /* 
     * Lock the descriptor.. if the lock fails with EWOULDBLOCK,
     * then there is already connection available that locked this,
     * so we are dealing with FastCGI processes.
     */
